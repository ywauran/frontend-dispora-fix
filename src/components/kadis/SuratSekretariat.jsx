...
const SuratSekretariat = () => {
  ...
  const getSuratSekretariat = async () => {
    ...
    setSuratsekretariat(response.data.result);
    ...
    <div className="flex-col w-[1440px] max-h-full">
      ...
      <div className="flex justify-center items-center">
        <h1 className="text-4xl text-center">
          Surat Masuk/Keluar Bidang Kerja Sekretariat
        </h1>
      </div>
      <hr className="mx-20" />
      ...
      <div className="flex w-full justify-center items-start">
        <div className="flex flex-col items-center justify-center">
            ...
            <div className="flex-col ">
              ...
              <div className="overflow-x-auto my-11">
                <table className="table w-[700px] justify-center  border ml-11 border-black">
                  ...
                  <tbody>
                    {suratsekretariat.map((item, index) => (
                      <tr key={item.uuid}>
                        <td className="p-4">{generateRowNumber(index)}</td>
                        <td className="p-4">{item.nama_surat_sekretariat}</td>
                        <td className="p-4">
                          {item.tanggal_surat_sekretariat}
                        </td>
                        <td className="p-4">
          ...
          <div className="">
            ...
            <Link
              to={"/form-surat-kerja-sekretariat"}
              type="submit"
              className="btn btn-outline btn-accent bg-green-500"
            >
              Tambah Surat Kerja Sekretariat
            </Link>
          </div>
...
export default SuratSekretariat;
