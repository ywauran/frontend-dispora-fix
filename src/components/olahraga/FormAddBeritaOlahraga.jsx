...
const FormAddBeritaOlahraga = () => {
  ...
  const saveBerita = async (e) => {
    ...
    try {
      await axios.post("http://localhost:4000/beritaolahraga", formData, {
        headers: {
          "Content-Type": "multipart/form-data",
        },
      });
      navigate("/add-berita-olahraga");
    } catch (error) {
      console.log(error);
    }
  };
  ...
  return (
    <div className="flex-col w-[1440px] max-h-full">
      ...
      {/* from start */}
      <form onSubmit={saveBerita} className="flex flex-col mx-40">
...
export default FormAddBeritaOlahraga;
