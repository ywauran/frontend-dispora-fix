          ...
          {data.map((item) => (
            ...
            >
              ...
              <div className="p-5 h-56 w-[700px] bg-[#D9D9D9] rounded-tr-xl rounded-br-xl">
                ...
                <p className="text-[#595959] py-1">{item.tanggal_berita}</p>
                <p className="truncate">
                  ISI BERITA : {item.isi_berita.slice(0, 100)}....
                </p>
                <div className="flex justify-end">
                  <Link
                    to={`/add-berita-pemuda/edit-berita-pemuda/${item.id}`}
                    className="
